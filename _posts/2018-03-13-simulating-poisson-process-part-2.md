---
layout: post
title: "&#128200; [archived] Simulating Poisson process (part 2)"
---

In [previous post](https://irudnyts.github.io/simulating-poisson-process-part-1/) we discussed two common methods of Poisson process simulation. The reason why this trivial problem was of my interest is the fact that this is simplification of a larger scale problem of a classical ruin process.
...
Let me remind that I focus on an extenssion of Cram&eacute;r–Lundberg model with positive jumps, that is:
